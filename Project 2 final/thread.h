...
/* The `elem' member has a dual purpose.  It can be an element in
   ...
   struct thread
   {
     ...
     struct hash supp_page_table;         /* Supplemental page table for virtual memory. */
     ...
     struct semaphore timer_sema;        /* Semaphore for timer sleeping. */
     ...
     struct semaphore wait_sema;         /* Semaphore for parent waiting for child exit. */
     struct semaphore load_sema;   /* Child posts after load() finishes */
     bool load_success;
...
extern struct thread *get_thread_by_tid (tid_t);
